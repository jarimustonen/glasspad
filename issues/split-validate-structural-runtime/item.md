...
LLM code review (Gemini + Codex consensus) during @provided-datasets-unused-2 fix review.

## Related

- @provided-datasets-unused-2 — added the `provided_datasets` check that surfaced this concern
