...
### Repro status
- **Not reproduced against live maalla.dev** (no external creds in this read-only worktree). 
...
### Fix sketch (a sketch, not an implementation — disposition is Jari's)
