...
# 41. Decide on auth error status codes (401 vs 403)
...
Masks pad existence entirely. Ties into #38 (visibility model decision).

## Context

This overlaps with #38. The status code choice depends on the visibility model:
- If pads are public-read (option A in #38), 401/403 distinction matters
- If pads are fully private (option B in #38), returning 404 for everything is simplest
