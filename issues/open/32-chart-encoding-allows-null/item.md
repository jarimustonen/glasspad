...
This creates a compound bug with #30: if `ChartConfig` lacks `deny_unknown_fields`, a misspelled `encoding` key silently defaults to null and passes validation.
