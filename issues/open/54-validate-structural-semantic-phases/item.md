...
# 54. Separate structural and semantic validation phases in validator
...
Review of issue #32 (reject null `chart.encoding`), where the fragility of the current approach became apparent.

## Related

- **#32** — chart encoding null validation (immediate trigger)
- **#33** — split structural vs runtime validation (orthogonal but complementary refactor)
