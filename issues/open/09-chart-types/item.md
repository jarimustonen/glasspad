...
## Overlap with #10 UML Diagrams

Issue #10 covers UML specifically. This issue is broader — it includes UML but also non-UML technical diagrams (flowcharts, C4, ER, Gantt, mind maps, network topology). The two issues share rendering technology (Mermaid covers most of both) but differ in scope.
