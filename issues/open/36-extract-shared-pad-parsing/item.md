...
# 36. Extract shared parse/validate pipeline from create_pad and update_pad
...
This duplication is what caused issue #31 (Content-Type check present in create but missing in update). The next validation change will likely drift again.
