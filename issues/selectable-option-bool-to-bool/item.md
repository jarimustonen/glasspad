...
status: obsolete
priority: normal
slug: selectable-option-bool-to-bool
closed: 2026-07-23
---

# Refactor selectable from Option<bool> to bool
...
Identified during LLM review of batch_actions validation (@selectable-batch-actions-unvalidated).
