...
status: open
priority: normal
slug: unreasonably-faithful-clam
---

# Basic 2D pivot table
...
Implement the core pivot table section type: a two-dimensional aggregation matrix with configurable rows, columns, and cell function (aggregation). Based on the universal four-zone model (Rows, Columns, Values, Filters) identified in the competitor analysis (@pivot-competitor-analysis).
...
- **@pivot-competitor-analysis** analysis.md — competitor feature comparison informing design decisions
