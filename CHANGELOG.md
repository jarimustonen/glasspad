...
### Fixed
- Markdown-authored relative `assets/` image and file links now resolve through the same-space asset route in hosted and loopback spaces without changing raw HTML or page navigation.
